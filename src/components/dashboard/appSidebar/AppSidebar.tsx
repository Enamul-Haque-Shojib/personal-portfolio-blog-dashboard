...
import { LogOut, CodeXml, Code, FolderOpenDot, FolderGit2, StickyNote, Rss, MessageSquareText, LayoutDashboard } from "lucide-react";
    ...
    >
      ...
      <SidebarHeader className="flex items-center justify-between py-4 px-4">
        <div className="flex items-center space-x-2">
          ...
          {sidebarOpen ? <h1 className="text-2xl font-bold text-black">Portfolio</h1> : <h1 className="text-2xl font-bold text-black">P</h1>}
        </div>
      ...
      <SidebarFooter className="mt-auto px-4 py-6">
        ...
        {!sidebarOpen && (
          <LogOut 
          className="w-5 h-5 cursor-pointer text-black hover:text-red-500"
            onClick={()=>{signOut()}}
           ></LogOut>
        )}
      </SidebarFooter>
